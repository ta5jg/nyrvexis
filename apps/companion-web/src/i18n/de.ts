...
export const de: Translations = {
  ...
  synergies: {
    activeLabel: "Aktive Synergien",
    appliedLabel: "Angewandte Synergien",
    frontline_2: "Frontlinie (2)",
    frontline_3: "Frontlinie (3)",
    frontline_4: "Frontlinie (4)",
    assault_2: "Angriff (2)",
    assault_3: "Angriff (3)",
    assault_4: "Angriff (4)",
    backline_2: "Hinterlinie (2)",
    backline_3: "Hinterlinie (3)",
    backline_4: "Hinterlinie (4)",
    control_2: "Kontrolle (2)",
    control_3: "Kontrolle (3)",
    vanguard_2: "Vorhut (2)",
    vanguard_3: "Vorhut (3)",
    vanguard_4: "Vorhut (4)",
    marauder_2: "Marodeur (2)",
    marauder_3: "Marodeur (3)",
    marauder_4: "Marodeur (4)",
    arcane_2: "Arkan (2)",
    arcane_3: "Arkan (3)",
    arcane_4: "Arkan (4)",
    ranger_2: "Jäger (2)",
  ...
  wallet: {
    connectTronLink: "TronLink verbinden",
    installTronLink: "TronLink installieren",
    connecting: "Verbinde…",
    connected: "Wallet",
    disconnect: "Trennen",
    connectFailed: "Verbindung fehlgeschlagen",
    payWithUsdtg: "Mit USDTg bezahlen",
    verifyingTx: "Transaktion wird geprüft…",
    txConfirmed: "Zahlung bestätigt",
    txFailed: "Zahlungsprüfung fehlgeschlagen",
    invalidTxHash: "Ungültiges Hash-Format",
    premiumOnVerify: "Premium wird nach Bestätigung aktiv",
    step1OpenWallet: "Öffne TronLink oder eine andere TRON-Wallet.",
    step2SendTo: "Sende USDTg an diese Treasury-Adresse:",
    step3Amount: "Betrag",
    step4PasteTxHash: "Füge den Transaktions-Hash unten ein.",
    iSentIt: "Gesendet →",
    copyAddress: "Adresse kopieren",
    txHashLabel: "Transaktions-Hash",
    txHashHint: "64-stelliger Hex-Wert aus der Tx-Detailansicht deiner Wallet.",
    verify: "Prüfen",
    back: "Zurück"
  },
  web3: {
    poweredBy: "Powered by USDTg auf TRON",
    earnUsdtg: "Tägliche Top-100-Spieler erhalten USDTg-Airdrops",
    web3Note: "Web-Version unterstützt USDTg-Kosmetika. Mobile-Version nur Fiat."
  }
};
