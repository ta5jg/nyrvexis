...
Copy **`TEMPLATE_store_listing.v1.json`** → `kindrail_store_listing.v1.json` (gitignore if contains unreleased copy), fill EN/TR (or target locales), then paste into App Store Connect and Google Play listings.
